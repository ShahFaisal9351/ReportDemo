...
namespace ReportDemo.Data.Migrations
{
    ...
    [Migration("20251204063204_FixSectionUniqueConstraint")]
    partial class FixSectionUniqueConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReportDemo.Models.Section", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReportDemo.Models.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReportDemo.Models.ExamResult", b =>
                {
                    ...
                    b.HasOne("ReportDemo.Models.Session", "Session")
                        .WithMany()
            ...
            modelBuilder.Entity("ReportDemo.Models.PromotionHistory", b =>
                {
                    ...
                    b.HasOne("ReportDemo.Models.Session", "NewSession")
                        .WithMany()
                    ...
                    b.HasOne("ReportDemo.Models.Session", "OldSession")
                        .WithMany()
            ...
            modelBuilder.Entity("ReportDemo.Models.Student", b =>
                {
                    ...
                    b.HasOne("ReportDemo.Models.Section", "Section")
                        .WithMany()
